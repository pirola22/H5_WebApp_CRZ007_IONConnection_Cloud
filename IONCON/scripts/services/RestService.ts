module h5.application {
    ...
    export interface IRestService {
       ...
       executeM3MIRestService(program: string, transaction: string, requestData: any, maxReturnedRecords?: number, company?: string, division?: string): ng.IPromise<M3.IMIResponse>;
        //executeMingleRestService(transaction: string, requestData: any): ng.IPromise<any>;
        executeMingleRestService(transaction: string, requestData: any, requestMethod?: string, contentType?: string): ng.IPromise<any>;
    }
...
private init() {
      ...
      public executeMingleRestService(transaction: string, requestData: any, requestMethod?: string, contentType?: string): ng.IPromise<any> {
